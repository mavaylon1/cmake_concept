...
set_target_properties(MyLibrary::MyLibrary PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libMyLibrary.dylib"
  IMPORTED_SONAME_NOCONFIG "@rpath/libMyLibrary.dylib"
  )

list(APPEND _cmake_import_check_targets MyLibrary::MyLibrary )
list(APPEND _cmake_import_check_files_for_MyLibrary::MyLibrary "${_IMPORT_PREFIX}/lib/libMyLibrary.dylib" )
